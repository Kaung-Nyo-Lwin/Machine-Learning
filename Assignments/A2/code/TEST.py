...
# app.layout = html.Div([
#     dcc.Tabs(id='tabs', value='New', children=[
#     dcc.Tab(label='New Model', value='New'),
#     dcc.Tab(label='Old Model', value='Old'),
#     ]),
...
# dcc.Tab(label='Old Model',children= [html.H1(children = 'Car Price Prediction',
...
#                   [html.H1(children = 'Car Price Prediction',
#                                     style={'textAlign': 'center', 'color': '#503D36',
#                                            'font-size': 40})])
